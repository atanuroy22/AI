...
#For Girl Voice Disable hey & Enable it----------------------
...
# Get a list of voices & Finding hey Voice--------------
...
for voice in voices:
    if voice.name == "hey":
        ...
        break
if hey_voice:
    engine.setProperty('voice', hey_voice.id)
engine.runAndWait()
...
def wish():
    ...
    if hour>=0 and hour<12:
        ...
        reply("Good Evening !")  
    reply("Hey Welcome, I am your Personal Asistance!!")    
...
def respond(voice_data):
    ...
    #     reply('your name is _____!')
        ...
        reply('i am a Personal Assistance!')
        ...
        try:
            ...
            voice_data = voice_data.replace('hey', '')
            try:
    ...
    #python
        ...
        try:
            ...
            #open hey folder like Atanu roy 
